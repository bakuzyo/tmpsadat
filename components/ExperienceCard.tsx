    ...
    return <article className='flex flex-col rounded-lg items-center space-y-7 flex-shrink-0
     ...
     overflow-hidden'>
        ...
        <div className='px-0 md:px-10'>
            <h4 className='text-4xl font-light'> I.sadat</h4>
            <p className='font-bold text-2xl mt-1'>Cabinet</p>
            ...
            <ul className='list-disc space-y-4 ml-5 text-lg'>
                <li>summ ary pont elektron octatrack lorem ipsum . . . !</li>
                <li>ssumm ary pont elektron octatrack lorem ipsum . . . !</li>
                <li>summ ary pont elektron octatrack lorem ipsum . . . !</li>
                <li>ssumm ary pont elektron octatrack lorem ipsum . . . !</li>
                <li>summ ary pont elektron octatrack lorem ipsum . . . !</li>
            </ul>
